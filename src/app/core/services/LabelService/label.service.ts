...
export class LabelService {
  ...
  public getLabels() {
    ...
    return this.http.get(this.API + '/label', header);
  }
  ...
  public deleteLabel(label) {
    ...
    return this.http.deleteWithParams(this.API + '/label/' + token, {
      params: {
        labelName: labelName
      }
    });
  ...
  public updateLabel(label) {
    var header = this.getHeader();
    return this.http.put(this.API + '/label', label, header);
  }

  public createLabel(label){
    var header = this.getHeader();
    return this.http.postWithBody(this.API + '/label', label, header);
  }
